...
namespace DevExpress.viz
{
    ...
    interface dxPieChartLegend : ICachedEntity { }
    
    [JsonConverter(typeof(CachedEntityConverter<dxPieChartLegendCachedEntity>))]
    class dxPieChartLegendCachedEntity : CachedEntityObject, dxPieChartLegend
    {
        ...
        #region Constructor
        public dxPieChartLegendCachedEntity() : base() { }

        public dxPieChartLegendCachedEntity(
