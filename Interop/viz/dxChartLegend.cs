...
namespace DevExpress.viz
{
    ...
    interface dxChartLegend : ICachedEntity { }
    
    [JsonConverter(typeof(CachedEntityConverter<dxChartLegendCachedEntity>))]
    class dxChartLegendCachedEntity : CachedEntityObject, dxChartLegend
    {
        ...
        #region Constructor
        public dxChartLegendCachedEntity() : base() { }

        public dxChartLegendCachedEntity(
