...
namespace BlazorApp.Shared
{
    public partial class FunnelComponent : ComponentBase
    {
        ...
        private protected ElementReference MainElement { get; set; }
        protected override async void OnAfterRender(bool firstRender)
        {
            ...
            if (firstRender)
            {
                ...
                var dxfo = new dxFunnelOptionsCachedEntity();
            ...
            new DataInfo{ Argument = "Renewed", Value = 1670 }
                ...
                await JsRuntime.InvokeVoidAsync("DxBlazor.Funnel.init", MainElement, dxfo, DotNetObjectReference.Create(this));
            }
        }
